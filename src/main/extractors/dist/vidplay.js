        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        id = _a.sent();
                        return [4 /*yield*/, axios_1.axiosInstance.get(this.url + "/futoken", {
                                headers: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        futoken = _a.sent();
                        url = this.url + "/mediainfo/" + futoken + "?" + sourceUrl.split('?')[1];
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.getFileUrl(url + "&autostart=true")];
                    case 1:
                        fileUrl = _c.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, utils_1.getResolutionFromM3u8(source, true)];
                    case 3:
                        quality = _c.sent();
