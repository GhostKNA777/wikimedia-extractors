...
exports.SmashyWatchXExtractor = void 0;
const crypto_1 = __importDefault(require("crypto"));
const axios_1 = require("../../utils/axios");
class SmashyWatchXExtractor {
    name = 'Smashy (WX)';
    ...
    async extractUrl(url) {
        try {
            ...
            const derivedKey = crypto_1.default.pbkdf2Sync(this.KEY, Buffer.from(base64DecryptedData.salt, 'hex'), base64DecryptedData.iterations, 32, 'sha512');
            ...
            const thumbnails = tracks.filter((it) => it.kind === 'thumbnails');
            return {
                server: this.name,
                source: {
                    url: sources[0].file,
...
exports.SmashyWatchXExtractor = SmashyWatchXExtractor;
//# sourceMappingURL=watchx.js.map